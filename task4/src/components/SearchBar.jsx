const SearchBar = ({search, setSearch, maxLength, setMaxLength, direction, setDirection}) => {
    ...
    return <>
        ...
        <button name="sort-direction" onClick={sortDirectionHandler} >{direction==='asc' ? 'Sort Descending':'Sort Ascending'}</button>
    </>
}
